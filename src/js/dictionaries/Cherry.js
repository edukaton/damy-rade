...
function Cherry(props) {
    return (
        <div className="dictionary">
            ...
            <Link title="Informacje dotyczące fałszywych ekspertów w internecie" to='/falszywy-ekspert'><div className="direction"><i className="fa fa-caret-square-o-left"></i> Wróć do Fałszywy ekspert</div></Link>
            </div>
            <div className="navnext">
            <Link title="Zadanie praktyczne o fałszywych informacjach i wyłudzeniach danych" to='/prawda-albo-falsz'><div className="direction">Przejdź do Prawda albo fałsz <i className="fa fa-caret-square-o-right"></i></div></Link>
            </div>
