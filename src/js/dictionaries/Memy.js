    ...
    return (
        ...
        <div className="dictionary">
            <div className="navback">
                <Link title="Informacje dotyczące krzykliwych nagłówków w internecie" to='/click-baity'><div className="direction"><i className="fa fa-caret-square-o-left"></i> Wróć do Click baity</div></Link>
            </div>
            <div className="navnext">
                <Link title="Informacje dotyczące pomijania informacji w internecie" to='/framing'><div className="direction">Przejdź do Framing <i className="fa fa-caret-square-o-right"></i></div></Link>
            </div>
