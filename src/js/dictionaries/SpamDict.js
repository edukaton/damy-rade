...
function SpamDict(props) {
    return (
        <div className="dictionary">
            ...
            <Link title="Informacje dotyczące blokowania reklam w internecie" to='/blokowanie-reklam'><div className="direction"><i className="fa fa-caret-square-o-left"></i> Wróć do Adblock</div></Link>
            </div>
            <div className="navnext">
            <Link title="Informacje dotyczące krzykliwych nagłówków w internecie" to='/click-baity'><div className="direction">Przejdź do Click baity <i className="fa fa-caret-square-o-right"></i></div></Link>
            </div>
