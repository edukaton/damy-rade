...
function SpamDict(props) {
    return (
        <div className="dictionary">
            ...
            <Link title="Informacje dotyczące blokowania reklam w internecie" to='/blokowanie-reklam'><div className="direction"><i class="fas fa-caret-square-left"></i> Wróć do Adblock</div></Link>
            </div>
            <div className="navnext">
            <Link title="Informacje dotyczące krzykliwych nagłówków w internecie" to='/click-baity'><div className="direction">Przejdź do Click baity <i class="fas fa-caret-square-right"></i></div></Link>
            </div>
